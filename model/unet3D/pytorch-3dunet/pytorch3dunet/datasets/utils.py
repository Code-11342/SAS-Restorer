...
def get_train_loaders(config):
    ...
    print(f"test loaders_config[train][file_paths]:{loaders_config['train']['file_paths']}")
    print(f"test loaders_config[val][file_paths]:{loaders_config['val']['file_paths']}")
    ...
    print("\n\n[Test] build train loader!:")
    print(f"train loader size:{len(ret_dataset_dict['train'])}")
    print(f"val loader size:{len(ret_dataset_dict['val'])}")
