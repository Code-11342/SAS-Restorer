...
def set_triangle_mesh_vertices(mesh, vertices):
...
def get_mesh_from_vol_smoothvis_path(label_path, mesh_path):
...
# mesh translate ops
def translate_triangle_mesh(mesh, translation):
    """
    translate o3d mesh
    """
...
def cpd_mesh_nonrigid_registration_probreg(
    ...
    """
    Mesh Non-rigid registration using probreg
    """
    ...
    def draw_mesh_stage(
        ...
        for mesh_idx, (cur_mesh, cur_color, cur_opacity, cur_translation, cur_smooth_flag) in \
            ...
            if(cur_translation is not None):
                cur_mesh = translate_triangle_mesh(mesh=cur_mesh, translation=cur_translation)
            # register mesh
